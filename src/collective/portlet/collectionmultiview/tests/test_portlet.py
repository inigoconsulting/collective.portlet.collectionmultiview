...
from collective.portlet.collectionmultiview.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_interfaces(self):
        ...
        portlet = collectionmultiview.Assignment()
    ...
    def test_invoke_add_view(self):
        ...
        self.failUnless(isinstance(mapping.values()[0],
                                   collectionmultiview.Assignment))
    ...
    def test_invoke_edit_view(self):
        ...
        mapping['foo'] = collectionmultiview.Assignment()
        editview = getMultiAdapter((mapping['foo'], request), name='edit')
        self.failUnless(isinstance(editview, collectionmultiview.EditForm))
    ...
    def test_obtain_renderer(self):
        ...
        self.failUnless(isinstance(renderer, collectionmultiview.Renderer))
...
class TestRenderer(TestCase):
    ...
    def renderer(self, context=None, request=None, view=None, manager=None,
        ...
        # constructor.
        assignment = assignment or collectionmultiview.Assignment()
